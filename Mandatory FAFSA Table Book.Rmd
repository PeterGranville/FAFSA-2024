...
This appendix contains the tables used in our full report. Each set of tables contains a "Data Source and Notes" tab containing methodological details. 

# Trends in FAFSA completion

The following tables examine how FAFSA completion rates have changed in states after introducing a mandatory FAFSA policy, with breakdowns by schools' community demographics and starting completion rates. 
...
preprocess.t1 <- function(data0, stateName, year0, year1){
  ...
  names(data0) <- gsub("last class before policy", year0, names(data0))
  names(data0) <- gsub("first class under policy", year1, names(data0))
  ...
  data0 <- data0 %>% arrange(desc(`State Category`))
...
```{r t1.LA}
kable(preprocess.t1(t1.LA, "Louisiana", "Class of 2017", "Class of 2018")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.IL}
kable(preprocess.t1(t1.IL, "Illinois", "Class of 2020", "Class of 2021")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.AL}
kable(preprocess.t1(t1.AL, "Alabama", "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.CO}
kable(preprocess.t1(t1.CO, "Colorado", "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.TX}
kable(preprocess.t1(t1.TX, "Texas", "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.CA}
kable(preprocess.t1(t1.CA, "California", "Class of 2022", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.MD}
kable(preprocess.t1(t1.MD, "Maryland", "Class of 2022", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.IN}
kable(preprocess.t1(t1.IN, "Indiana", "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.NH}
kable(preprocess.t1(t1.NH, "New Hampshire", "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```
...
Tables A1 through A9 inform Table 1 in the report. 
...
Figures B1 through B7 inform Table 3 in the report. 
...
preprocess.t2 <- function(data0, year0, year1){
  ...
  if(length(names(data0))==8){
    data0 <- data0 %>% mutate(
      ...
      `Change in completion rate` = ifelse(
        ...
        paste("+", round(`Change in completion rate` * 100, 1), " pp", sep=""), 
        paste("-", round(`Change in completion rate` * 100, 1), " pp", sep="")
      )
    ) 
  }else{
  ...
  names(data0) <- gsub(" before policy", paste(", ", year0, sep=""), names(data0))
  names(data0) <- gsub(" after policy", paste(", ", year1, sep=""), names(data0))
...
```{r t2abs.LA}
kable(preprocess.t2(t2abs.LA, "Class of 2017", "Class of 2018")) %>% kable_paper("hover", full_width = F)
```

##### Table C1b: Relative changes in FAFSA completions: Louisiana

```{r t2rel.LA}
kable(preprocess.t2(t2rel.LA, "Class of 2017", "Class of 2018")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.IL}
kable(preprocess.t2(t2abs.IL, "Class of 2020", "Class of 2021")) %>% kable_paper("hover", full_width = F)
```

##### Table C2b: Relative changes in FAFSA completions: Illinois

```{r t2rel.IL}
kable(preprocess.t2(t2rel.IL, "Class of 2020", "Class of 2021")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.AL}
kable(preprocess.t2(t2abs.AL, "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```

##### Table C3b: Relative changes in FAFSA completions: Alabama

```{r t2rel.AL}
kable(preprocess.t2(t2rel.AL, "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.TX}
kable(preprocess.t2(t2abs.TX, "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```

##### Table C4b: Relative changes in FAFSA completions: Texas

```{r t2rel.TX}
kable(preprocess.t2(t2rel.TX, "Class of 2021", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.CA}
kable(preprocess.t2(t2abs.CA, "Class of 2022", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```

##### Table C5b: Relative changes in FAFSA completions: California

```{r t2rel.CA}
kable(preprocess.t2(t2rel.CA, "Class of 2022", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.IN}
kable(preprocess.t2(t2abs.IN, "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```

##### Table C6b: Relative changes in FAFSA completions: Indiana

```{r t2rel.IN}
kable(preprocess.t2(t2rel.IN, "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.NH}
kable(preprocess.t2(t2abs.NH, "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```

##### Table C7b: Relative changes in FAFSA completions: New Hampshire

```{r t2rel.NH}
kable(preprocess.t2(t2rel.NH, "Class of 2023", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```
...
Tables C1 through C7 inform Table 2 in the report. 
...
preprocessRecipients <- function(data0){
  ...
  data0 <- data0 %>% arrange(`Comparison window`, `Selected state`, `Selected institutions`)
...
##### Table D2a: Changes in Pell Grant recipients by institution's Pell share of undergraduate enrollment

```{r pell.pell.a}
kable(recipients.pell) %>% kable_paper("hover", full_width = F)
```

##### Table D2b: Changes in Pell Grant disbursements by institution's Pell share of undergraduate enrollment
...
##### Table D3a: Changes in Pell Grant recipients by institution's control

```{r pell.control.a}
kable(recipients.control) %>% kable_paper("hover", full_width = F)
```

##### Table D3b: Changes in Pell Grant disbursements by institution's control
...
##### Table D4a: Changes in Pell Grant recipients by institution's predominant degree awarded

```{r pell.preddeg.a}
kable(recipients.preddeg) %>% kable_paper("hover", full_width = F)
```

##### Table D4b: Changes in Pell Grant disbursements by institution's predominant degree awarded
...
##### Table D5a: Changes in Pell Grant recipients by institution's MSI status
...
##### Table D5b: Changes in Pell Grant disbursements by institution's MSI status
...
##### Table D6a: Changes in Pell Grant recipients for all institutions

```{r pell.bigwindow.a}
kable(preprocessRecipients(bigWindowR)) %>% kable_paper("hover", full_width = F)
```

##### Table D6b: Changes in Pell Grant disbursements for all institutions
...
##### Table D7: Total count of Pell Grant recipients
...
Notes: The maximum window of comparison uses the last year before policy enactment and compares it to 2023-24, the latest year for which full Pell Grant data are available. "Pell share" refers to the "PCTPELL" variable in the College Scorecard, with values below 30% considered "low," values between 30% and 60% considered "medium," and values above 60% considered "high." 

###  {.unnumbered}

Tables D1 through D7 inform Table 4 in the report. 

## Changes in Undergraduate Enrollment

The set of tables below examines how the number of undergraduate students enrolled at institutions have changed after the institutions' states have implemented FAFSA requirements. 
...
setStudentLevels <- c(
  ...
  "Black or African American undergraduates", 
  "Hispanic or Latino undergraduates", 
  "Native American or Alaska Native undergraduates", 
  "Native Hawaiian or Other Pacific Islander undergraduates", 
  "White undergraduates", 
  "Undergradutes of two or more races", 
  "First-time undergraduates", 
  "Full-time undergraduates", 
  "Full-time first-time undergraduates",
  "Part-time undergraduates",
  "Part-time first-time undergraduates",
  "Undergraduates at high-Pell institutions", 
  "Undergraduates at medium-Pell institutions", 
  "Undergraduates at low-Pell institutions", 
  "Undergraduates at public institutions", 
  "Undergraduates at nonprofit institutions", 
  "Undergraduates at for-profit institutions", 
  "Undergraduates at certificate-granting institutions", 
  "Undergraduates at associate-granting institutions", 
  "Undergraduates at bachelor-granting institutions"
)
```
...
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "All undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Asian undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Black or African American undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Hispanic or Latino undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Native American or Alaska Native undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Native Hawaiian or Other Pacific Islander undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "White undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergraduates",
  ...
  `Selected students` = "Undergradutes of two or more races"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Full-time undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Full-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Full-time first-time undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Full-time first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Part-time undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Part-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Part-time first-time undergraduates",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Part-time first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "High Pell",
  `Student category` = "Undergraduates",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at high-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Medium Pell",
  `Student category` = "Undergraduates",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at medium-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Low Pell",
  `Student category` = "Undergraduates",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at low-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "Undergraduates",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at public institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "Undergraduates",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at nonprofit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "Undergraduates",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at for-profit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "Undergraduates",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at certificate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "Undergraduates",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at associate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "Undergraduates",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergraduates at bachelor-granting institutions"
)
...
preprocessEnroll <- function(data0){
  ...
  data0 <- data0 %>% rename(
    `Comparison years (Fall semester)` = `Comparison years`
  ) %>% select(
    `Selected state`, 
    `Comparison years (Fall semester)`, 
    `Selected students`, 
  ...
  data0 <- data0 %>% arrange(`Comparison years (Fall semester)`, `Selected state`, `Selected students`)
...
```{r preprocessEnrollTotals}

preprocessEnrollTotals <- fuction(data0){
  ...
  data0 <- data0 %>% rename(
    `Enrollment level, before policy` = `Before policy`, 
    `Enrollment level, after policy` = `After policy`, 
  ) %>% mutate(
    `Enrollment level, before policy` = comma(`Enrollment level, before policy`), 
    `Enrollment level, after policy` = comma(`Enrollment level, after policy`), 
    `Change` = percent(`Change`, accuracy=0.1)
  ) %>% select(
    `Selected state`, 
    `Comparison years (Fall semester)`, 
    `Selected students`, 
    `Enrollment level, before policy`, 
    `Enrollment level, after policy`, 
    `Change`
  ) 
...
```{r enroll.ftft}
kable(preprocessEnroll(enroll.ftft)) %>% kable_paper("hover", full_width = F)
```
...
```{r enroll.pell}
kable(preprocessEnroll(enroll.pell)) %>% kable_paper("hover", full_width = F)
```
...
```{r enroll.control}
kable(preprocessEnroll(enroll.control)) %>% kable_paper("hover", full_width = F)
```
...
```{r enroll.preddeg}
kable(preprocessEnroll(enroll.preddeg)) %>% kable_paper("hover", full_width = F)
```
...
```{r enroll.race}
kable(preprocessEnroll(enroll.race)) %>% kable_paper("hover", full_width = F)
```

##### Table E6: Totals 

```{r enroll.totals}
kable(preprocessEnrollTotals(enroll.totals)) %>% kable_paper("hover", full_width = F)
```

#### Data Source and Notes 

Source: Author's analysis of data from the Integrated Postsecondary Education Data System (IPEDS), fall enrollment survey, with institutional information derived from the College Scorecard. 
...
Tables E1 through E6 inform Table 5 in the report. 
...
comp1 <- comp1 %>% mutate(
  ...
  `Percentage point change` = ifelse(
    ...
    paste("+", round(`Percentage point change` * 100, 1), " pp", sep=""), 
    paste("-", round(`Percentage point change` * 100, 1), " pp", sep="")
  )
) %>% mutate(
  `Class of 2022` = percent(`Class of 2022`, accuracy=0.1), 
  `Class of 2023` = percent(`Class of 2023`, accuracy=0.1)
) %>% rename(
...
preprocessMixedStatus <- function(data0){
  ...
  data0 <- data0 %>% add_row(
    `State` = "U.S. overall", 
    `Young adults aged 17 to 23` = sum(data0$`Young adults aged 17 to 23`, na.rm=TRUE), 
    `Grade 12 students` = sum(data0$`Grade 12 students`, na.rm=TRUE)
  )
    
  data0 <- data0 %>% mutate(
    `Young adults aged 17 to 23` = comma(round(`Young adults aged 17 to 23`, -3)), 
    `Grade 12 students` = comma(round(`Grade 12 students`, -3))
  ) 
...
```{r mixedStatus}
kable(preprocessMixedStatus(aggMS)) %>% kable_paper("hover", full_width = F)
```
...
Notes: Individuals are typically treated as dependent for FAFSA-filing purposes until they are aged 24, married, or enrolled in graduate school. The second column of Table F3 reflects citizens who are aged 17 to 23, are not married, and who are not enrolled in graduate school. The third table of column F3 reflects citizens who are enrolled in grade 12 and are not married. 

###  {.unnumbered}

Table F2 informs Table 6 in the report, and Table F3 informs Table 7 in the report. 

Please email Peter Granville at [granville@tcf.org](granville@tcf.org) with any questions.
