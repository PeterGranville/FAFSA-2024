...
setStudentLevels <- c(
  ...
  "Asian first-time undergraduates", 
  "Black or African American first-time undergraduates", 
  "Hispanic or Latino first-time undergraduates", 
  "Native American or Alaska Native first-time undergraduates", 
  "Native Hawaiian or Other Pacific Islander first-time undergraduates", 
  "White first-time undergraduates", 
  "First-time undergraduates of two or more races", 
  "Full-time first-time undergraduates",
  "Part-time first-time undergraduates",
  "First-time undergraduates at high-Pell institutions", 
  "First-time undergraduates at medium-Pell institutions", 
  "First-time undergraduates at low-Pell institutions", 
  "First-time undergraduates at public institutions", 
  "First-time undergraduates at nonprofit institutions", 
  "First-time undergraduates at for-profit institutions", 
  "First-time undergraduates at certificate-granting institutions", 
  "First-time undergraduates at associate-granting institutions", 
  "First-time undergraduates at bachelor-granting institutions"
)
```
...
studentTable <- studentTable %>% add_row(
  ...
  `Selected students` = "All first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "Asian first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "Black or African American first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "Hispanic or Latino first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "Native American or Alaska Native first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "Native Hawaiian or Other Pacific Islander first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "White first-time undergraduates"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergraduates",
  ...
  `Selected students` = "First-time undergraduates of two or more races"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
...
studentTable <- studentTable %>% add_row(
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at high-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Medium Pell",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at medium-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Low Pell",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at low-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "First-time undergraduates",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at public institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at nonprofit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at for-profit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "First-time undergraduates",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at certificate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at associate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "First-time undergraduates",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergraduates at bachelor-granting institutions"
)
...
enroll.pell <- rbind(
  # Enrollment: All first-time undergraduates by Pell share
  enroll.PCTPELL.LA,
  enroll.PCTPELL.IL,
  enroll.PCTPELL.AL,
  enroll.PCTPELL.TX, 
...
enroll.control <- rbind(
  # Enrollment: All first-time undergraduates by institutional control
  enroll.CONTROL.LA,
  enroll.CONTROL.IL,
  enroll.CONTROL.AL,
  enroll.CONTROL.TX, 
...
enroll.preddeg <- rbind(
  # Enrollment: All first-time undergraduates by predominant degree awarded
  enroll.PREDDEG.LA,
  enroll.PREDDEG.IL,
  enroll.PREDDEG.AL,
  enroll.PREDDEG.TX, 
...
```{r enroll.overall}
kable(preprocessEnroll(enroll.overall)) %>% kable_paper("hover", full_width = F)
```
