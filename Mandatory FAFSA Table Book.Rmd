---
title: "Mandatory FAFSA Table Book"
...
processEnrollment <- function(data0, state0, year1, year2, students, demographic, interestVar, printTotals){
  ...
  if(students == "Part-time undergrads"){data1 <- data1 %>% filter(`EFFYALEV` == 42)}
  if(students == "Part-time first-time undergrads"){data1 <- data1 %>% filter(`EFFYALEV` == 44)}
  if(students %in% c(
    "Undergrads", 
...
enroll.TOTL.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.TOTL.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.TOTL.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.TOTL.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: ASIA
enroll.ASIA.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="ASIA", interestVar="None", printTotals=FALSE)
enroll.ASIA.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="ASIA", interestVar="None", printTotals=FALSE)
enroll.ASIA.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="ASIA", interestVar="None", printTotals=FALSE)
enroll.ASIA.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="ASIA", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: BKAA
enroll.BKAA.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="BKAA", interestVar="None", printTotals=FALSE)
enroll.BKAA.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="BKAA", interestVar="None", printTotals=FALSE)
enroll.BKAA.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="BKAA", interestVar="None", printTotals=FALSE)
enroll.BKAA.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="BKAA", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: HISP
enroll.HISP.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="HISP", interestVar="None", printTotals=FALSE)
enroll.HISP.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="HISP", interestVar="None", printTotals=FALSE)
enroll.HISP.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="HISP", interestVar="None", printTotals=FALSE)
enroll.HISP.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="HISP", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: AIAN
enroll.AIAN.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="AIAN", interestVar="None", printTotals=FALSE)
enroll.AIAN.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="AIAN", interestVar="None", printTotals=FALSE)
enroll.AIAN.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="AIAN", interestVar="None", printTotals=FALSE)
enroll.AIAN.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="AIAN", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: NHPI
enroll.NHPI.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="NHPI", interestVar="None", printTotals=FALSE)
enroll.NHPI.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="NHPI", interestVar="None", printTotals=FALSE)
enroll.NHPI.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="NHPI", interestVar="None", printTotals=FALSE)
enroll.NHPI.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="NHPI", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: WHIT
enroll.WHIT.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="WHIT", interestVar="None", printTotals=FALSE)
enroll.WHIT.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="WHIT", interestVar="None", printTotals=FALSE)
enroll.WHIT.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="WHIT", interestVar="None", printTotals=FALSE)
enroll.WHIT.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="WHIT", interestVar="None", printTotals=FALSE)

# All undergraduates by race/ethnicity: 2MOR
enroll.2MOR.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="2MOR", interestVar="None", printTotals=FALSE)
enroll.2MOR.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="2MOR", interestVar="None", printTotals=FALSE)
enroll.2MOR.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="2MOR", interestVar="None", printTotals=FALSE)
enroll.2MOR.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="2MOR", interestVar="None", printTotals=FALSE)
...
enroll.UG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.UG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.UG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# First-time undergraduate students: TOTL
enroll.1TUG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="First-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.1TUG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="First-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.1TUG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="First-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# Full-time undergraduate students: TOTL
enroll.FTUG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Full-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.FTUG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Full-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.FTUG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Full-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# Full-time, first-time undergraduate students: TOTL
enroll.FT1TUG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Full-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.FT1TUG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Full-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.FT1TUG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Full-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# Part-time undergraduate students: TOTL
enroll.PTUG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Part-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.PTUG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Part-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.PTUG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Part-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)

# Part-time, first-time undergraduate students: TOTL
enroll.PT1GUG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Part-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.PT1GUG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Part-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
enroll.PT1GUG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Part-time first-time undergrads", demographic="TOTL", interestVar="None", printTotals=FALSE)
...
enroll.PCTPELL.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="TOTL", interestVar="PCTPELL", printTotals=FALSE)
enroll.PCTPELL.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="TOTL", interestVar="PCTPELL", printTotals=FALSE)
enroll.PCTPELL.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="PCTPELL", printTotals=FALSE)
enroll.PCTPELL.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="PCTPELL", printTotals=FALSE)
...
enroll.CONTROL.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="TOTL", interestVar="CONTROL", printTotals=FALSE)
enroll.CONTROL.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="TOTL", interestVar="CONTROL", printTotals=FALSE)
enroll.CONTROL.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="CONTROL", printTotals=FALSE)
enroll.CONTROL.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="CONTROL", printTotals=FALSE)
...
enroll.PREDDEG.LA <- processEnrollment(data0=enrollment, state0="LA", year1=2018, year2=2019, students="Undergrads", demographic="TOTL", interestVar="PREDDEG", printTotals=FALSE) %>% filter(`Variable` %in% c(1, 2, 3))
enroll.PREDDEG.IL <- processEnrollment(data0=enrollment, state0="IL", year1=2021, year2=2022, students="Undergrads", demographic="TOTL", interestVar="PREDDEG", printTotals=FALSE) %>% filter(`Variable` %in% c(1, 2, 3))
enroll.PREDDEG.AL <- processEnrollment(data0=enrollment, state0="AL", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="PREDDEG", printTotals=FALSE) %>% filter(`Variable` %in% c(1, 2, 3))
enroll.PREDDEG.TX <- processEnrollment(data0=enrollment, state0="TX", year1=2022, year2=2023, students="Undergrads", demographic="TOTL", interestVar="PREDDEG", printTotals=FALSE) %>% filter(`Variable` %in% c(1, 2, 3))
...
preprocess.t1 <- function(data0, stateName, year0){
  
  data0 <- data0 %>% mutate(
    `State Category` = gsub("Selected State", stateName, `State Category`), 
    `Year of policy start` = rep(year0), 
    `Before policy` = comma(`Before policy`), 
    `After policy` = comma(`After policy`), 
    `Change` = percent(`Change`, accuracy=0.01), 
    `Over baseline` = ifelse(
      `Over baseline` >= 0, 
      paste("+", round(`Over baseline` * 100, 2), " pp", sep=""), 
      paste("-", round(`Over baseline` * 100, 2), " pp", sep="")
    )
  ) %>% rename(
    `FAFSA completions, last class before policy` = `Before policy`, 
    `FAFSA completions, first class under policy` = `After policy`, 
    `Performance over national baseline` = `Over baseline`
  )
  
  data0$`State Category` = as.factor(data0$`State Category`)
  data0$`State Category` = factor(data0$`State Category`, levels=rev(levels(data0$`State Category`)))
...
```{r t1.LA}
kable(preprocess.t1(t1.LA, "Louisiana", "Class of 2018")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.IL}
kable(preprocess.t1(t1.IL, "Illinois", "Class of 2021")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.AL}
kable(preprocess.t1(t1.AL, "Alabama", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.CO}
kable(preprocess.t1(t1.CO, "Colorado", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.TX}
kable(preprocess.t1(t1.TX, "Texas", "Class of 2022")) %>% kable_paper("hover", full_width = F)
```

#### Indiana

##### Table A6: Changes in statewide completion rate: Indiana (2024)

```{r t1.IN}
kable(preprocess.t1(t1.IN, "Indiana", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```

#### California

##### Table A7: Changes in statewide completion rate: California (2023)

```{r t1.CA}
kable(preprocess.t1(t1.CA, "California", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```

#### Maryland

##### Table A8: Changes in statewide completion rate: Maryland (2023)

```{r t1.MD}
kable(preprocess.t1(t1.MD, "Maryland", "Class of 2023")) %>% kable_paper("hover", full_width = F)
```
...
```{r t1.NH}
kable(preprocess.t1(t1.NH, "New Hampshire", "Class of 2024")) %>% kable_paper("hover", full_width = F)
```
...
```{r qLA1}
ggplotly(qLA1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B1b: FAFSA completion rates by attainment rate: Louisiana

```{r qLA2}
ggplotly(qLA2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B1c: FAFSA completion rates by race: Louisiana

```{r qLA3}
ggplotly(qLA3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qIL1}
ggplotly(qIL1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B2b: FAFSA completion rates by attainment rate: Illinois

```{r qIL2}
ggplotly(qIL2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B2c: FAFSA completion rates by race: Illinois

```{r qIL3}
ggplotly(qIL3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qAL1}
ggplotly(qAL1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B3b: FAFSA completion rates by attainment rate: Alabama

```{r qAL2}
ggplotly(qAL2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B3c: FAFSA completion rates by race: Alabama

```{r qAL3}
ggplotly(qAL3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qTX1}
ggplotly(qTX1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B4b: FAFSA completion rates by attainment rate: Texas

```{r qTX2}
ggplotly(qTX2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B4c: FAFSA completion rates by race: Texas

```{r qTX3}
ggplotly(qTX3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qCA1}
ggplotly(qCA1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B5b: FAFSA completion rates by attainment rate: California

```{r qCA2}
ggplotly(qCA2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B5c: FAFSA completion rates by race: California

```{r qCA3}
ggplotly(qCA3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qIN1}
ggplotly(qIN1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B6b: FAFSA completion rates by attainment rate: Indiana

```{r qIN2}
ggplotly(qIN2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B6c: FAFSA completion rates by race: Indiana

```{r qIN3}
ggplotly(qIN3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
```{r qNH1}
ggplotly(qNH1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B7b: FAFSA completion rates by attainment rate: New Hampshire

```{r qNH2}
ggplotly(qNH2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```

##### Figure B7c: FAFSA completion rates by race: New Hampshire

```{r qNH3}
ggplotly(qNH3, width=q3width, height=q3height, tooltip="text") %>% layout(legend = list(orientation = "h"))
```
...
preprocess.t2 <- function(data0){
  
  data0 <- data0 %>% mutate(
    `Completions before policy` = comma(`Completions before policy`), 
    `Completions after policy` = comma(`Completions after policy`)
  )
  
  if(length(names(data0))==8){
    data0 <- data0 %>% mutate(
      `Grade 12 students before policy` = comma(`Grade 12 students before policy`), 
      `Grade 12 students after policy` = comma(`Grade 12 students after policy`), 
      `Completion rate before policy` = percent(`Completion rate before policy`, accuracy=0.1), 
      `Completion rate after policy` = percent(`Completion rate after policy`, accuracy=0.1), 
      `Change in completion rate` = ifelse(
        `Change in completion rate` >= 0, 
        paste("+", round(`Change in completion rate` * 100, 2), " pp", sep=""), 
        paste("-", round(`Change in completion rate` * 100, 2), " pp", sep="")
      )
    ) 
  }else{
    data0 <- data0 %>% mutate(
      `Change in completions` = ifelse(
        `Change in completions` >= 0, 
        paste("+", percent(`Change in completions`, accuracy=0.1), sep=""), 
        percent(`Change in completions`, accuracy=0.1)
      )
    )
  }
...
```{r t2abs.LA}
kable(preprocess.t2(t2abs.LA)) %>% kable_paper("hover", full_width = F)
```

##### Table C1b: Relative changes in FAFSA completions: Louisiana

```{r t2rel.LA}
kable(preprocess.t2(t2rel.LA)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.IL}
kable(preprocess.t2(t2abs.IL)) %>% kable_paper("hover", full_width = F)
```

##### Table C2b: Relative changes in FAFSA completions: Illinois

```{r t2rel.IL}
kable(preprocess.t2(t2rel.IL)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.AL}
kable(preprocess.t2(t2abs.AL)) %>% kable_paper("hover", full_width = F)
```

##### Table C3b: Relative changes in FAFSA completions: Alabama

```{r t2rel.AL}
kable(preprocess.t2(t2rel.AL)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.TX}
kable(preprocess.t2(t2abs.TX)) %>% kable_paper("hover", full_width = F)
```

##### Table C4b: Relative changes in FAFSA completions: Texas

```{r t2rel.TX}
kable(preprocess.t2(t2rel.TX)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.CA}
kable(preprocess.t2(t2abs.CA)) %>% kable_paper("hover", full_width = F)
```

##### Table C5b: Relative changes in FAFSA completions: California

```{r t2rel.CA}
kable(preprocess.t2(t2rel.CA)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.IN}
kable(preprocess.t2(t2abs.IN)) %>% kable_paper("hover", full_width = F)
```

##### Table C6b: Relative changes in FAFSA completions: Indiana

```{r t2rel.IN}
kable(preprocess.t2(t2rel.IN)) %>% kable_paper("hover", full_width = F)
```
...
```{r t2abs.NH}
kable(preprocess.t2(t2abs.NH)) %>% kable_paper("hover", full_width = F)
```

##### Table C7b: Relative changes in FAFSA completions: New Hampshire

```{r t2rel.NH}
kable(preprocess.t2(t2rel.NH)) %>% kable_paper("hover", full_width = F)
```
...
setLevels <- c(
  ...
  "Predominantly associate-granting", 
  "Predominantly bachelor-granting",
  "HBCUs", 
  "PBIs", 
  "ANNHIs",
  "TCUs",
...
selectionTable <- data.frame(
  ...
  `Variable` = character(), 
  `Selected institutions` = character(), 
  check.names=FALSE
)

selectionTable <- selectionTable %>% add_row(
  `Variable name` = "None", 
  `Variable` = "All", 
  `Selected institutions` = "All"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "CONTROL", 
  `Variable` = "1", 
  `Selected institutions` = "Public institutions"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "CONTROL", 
  `Variable` = "2", 
  `Selected institutions` = "Nonprofit institutions"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "CONTROL", 
  `Variable` = "3", 
  `Selected institutions` = "For-profit institutions"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PREDDEG", 
  `Variable` = "0", 
  `Selected institutions` = "Predominant degree: Not classified"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PREDDEG", 
  `Variable` = "1", 
  `Selected institutions` = "Predominantly certificate-granting"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PREDDEG", 
  `Variable` = "2", 
  `Selected institutions` = "Predominantly associate-granting"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PREDDEG", 
  `Variable` = "3", 
  `Selected institutions` = "Predominantly bachelor-granting"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PREDDEG", 
  `Variable` = "4", 
  `Selected institutions` = "Entirely graduate-granting"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "HBCU", 
  `Variable` = "1", 
  `Selected institutions` = "HBCUs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "PBI", 
  `Variable` = "1", 
  `Selected institutions` = "PBIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "ANNHI", 
  `Variable` = "1", 
  `Selected institutions` = "ANNHIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "TRIBAL", 
  `Variable` = "1", 
  `Selected institutions` = "TCUs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "AANAPII", 
  `Variable` = "1", 
  `Selected institutions` = "AANAPIIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "HSI", 
  `Variable` = "1", 
  `Selected institutions` = "HSIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "NANTI", 
  `Variable` = "1", 
  `Selected institutions` = "NANTIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "MSI", 
  `Variable` = "1", 
  `Selected institutions` = "All MSIs"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "UPGRNTP", 
  `Variable` = "High Pell", 
  `Selected institutions` = "High-Pell institutions"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "UPGRNTP", 
  `Variable` = "Medium Pell", 
  `Selected institutions` = "Medium-Pell institutions"
)
selectionTable <- selectionTable %>% add_row(
  `Variable name` = "UPGRNTP", 
  `Variable` = "Low Pell", 
  `Selected institutions` = "Low-Pell institutions"
)

```

```{r preprocessRecipients}

preprocessRecipients <- function(data0){
  
  data0 <- left_join(
    x=data0, y=selectionTable, by=c("Variable", "Variable name")
  ) %>% filter(
    is.na(`Selected institutions`)==FALSE, 
    is.na(`Selected State`)==FALSE,
    is.infinite(`Selected State`)==FALSE,
    `Selected institutions` != "Entirely graduate-granting"
  )
  ...
  data0 <- data0 %>% select(
    ...
    `Selected State`,
    `Rest of U.S.`, 
    `Performance over rest of U.S.`
  ) %>% rename(
    `Change in Pell recipients, selected state` = `Selected State`,
    `Change in Pell recipients, rest of U.S.` = `Rest of U.S.`
  ) %>% mutate(
    `Change in Pell recipients, selected state` = percent(`Change in Pell recipients, selected state`, accuracy=0.1),
    `Change in Pell recipients, rest of U.S.` = percent(`Change in Pell recipients, rest of U.S.`, accuracy=0.1), 
    `Performance over rest of U.S.` = ifelse(
      `Performance over rest of U.S.` >= 0, 
      paste("+", round(`Performance over rest of U.S.` * 100, 1), " pp", sep=""), 
      paste("-", round(`Performance over rest of U.S.` * 100, 1), " pp", sep="")
    )
  )
  
  data0$`Selected institutions` <- as.factor(data0$`Selected institutions`)
  data0$`Selected institutions` <- factor(data0$`Selected institutions`, levels=setLevels)
  
  data0 <- data0 %>% arrange(`State`, `Selected institutions`)
...
```{r preprocessDisbursements}

preprocessDisbursements <- function(data0){
  ...
  data0 <- data0 %>% select(
    ...
    `Change in Pell disbursements, selected state` = `Selected State`,
    `Change in Pell disbursements, rest of U.S.` = `Rest of U.S.`
  ) %>% mutate(
    `Change in Pell disbursements, selected state` = percent(`Change in Pell disbursements, selected state`, accuracy=0.1),
    `Change in Pell disbursements, rest of U.S.` = percent(`Change in Pell disbursements, rest of U.S.`, accuracy=0.1), 
    `Performance over rest of U.S.` = ifelse(
      `Performance over rest of U.S.` >= 0, 
      paste("+", round(`Performance over rest of U.S.` * 100, 1), " pp", sep=""), 
      paste("-", round(`Performance over rest of U.S.` * 100, 1), " pp", sep="")
...
preprocessTotals <- function(data0){
  ...
  data0 <- data0 %>% select(
    ...
    `Before policy` = comma(`Before policy`), 
    `After policy` = comma(`After policy`), 
    `Percentage change` = percent(`Percentage change`, accuracy=0.1)
  )
...
```{r breakIntoTables.Recipients}

recipients.all <- preprocessRecipients(recipientsPull) %>% filter(`Selected institutions` == "All")

recipients.control <- preprocessRecipients(recipientsPull) %>% filter(`Selected institutions` %in% c(
  "Public institutions", 
  "Nonprofit institutions", 
  "For-profit institutions"
))
recipients.preddeg <- preprocessRecipients(recipientsPull) %>% filter(`Selected institutions` %in% c(
  "Predominantly certificate-granting", 
  "Predominantly associate-granting", 
  "Predominantly bachelor-granting"
))
recipients.msi <- preprocessRecipients(recipientsPull) %>% filter(`Selected institutions` %in% c(
  "HBCUs", 
  "PBIs", 
  "ANNHIs",
  "TCUs",
...
recipients.pell <- preprocessRecipients(recipientsPull) %>% filter(`Selected institutions` %in% c(
  "High-Pell institutions", 
  "Medium-Pell institutions", 
  "Low-Pell institutions"
))
...
```{r breakIntoTables.Disbursements}

disbursements.all <- preprocessDisbursements(disbursementsPull) %>% filter(`Selected institutions` == "All")

disbursements.control <- preprocessDisbursements(disbursementsPull) %>% filter(`Selected institutions` %in% c(
  "Public institutions", 
  "Nonprofit institutions", 
  "For-profit institutions"
))
disbursements.preddeg <- preprocessDisbursements(disbursementsPull) %>% filter(`Selected institutions` %in% c(
  "Predominantly certificate-granting", 
  "Predominantly associate-granting", 
  "Predominantly bachelor-granting"
))
disbursements.msi <- preprocessDisbursements(disbursementsPull) %>% filter(`Selected institutions` %in% c(
  "HBCUs", 
  "PBIs", 
  "ANNHIs",
  "TCUs",
...
disbursements.pell <- preprocessDisbursements(disbursementsPull) %>% filter(`Selected institutions` %in% c(
  "High-Pell institutions", 
  "Medium-Pell institutions", 
  "Low-Pell institutions"
))
...
##### Table D1: Changes in Pell Grants for all institutions 

```{r pell.all}
kable(recipients.all) %>% kable_paper("hover", full_width = F)
kable(disbursements.all) %>% kable_paper("hover", full_width = F)
```

#### By Pell Share of Enrollment

##### Table D2: Changes in Pell Grants by institution's Pell share of undergraduate enrollment

```{r pell.pell}
kable(recipients.pell) %>% kable_paper("hover", full_width = F)
kable(disbursements.pell) %>% kable_paper("hover", full_width = F)
```

#### By Control

##### Table D3: Changes in Pell Grants by institution's control

```{r pell.control}
kable(recipients.control) %>% kable_paper("hover", full_width = F)
kable(disbursements.control) %>% kable_paper("hover", full_width = F)
```

#### By Predominant Degree

##### Table D4: Changes in Pell Grants by institution's predominant degree awarded

```{r pell.preddeg}
kable(recipients.preddeg) %>% kable_paper("hover", full_width = F)
kable(disbursements.preddeg) %>% kable_paper("hover", full_width = F)
```

#### By MSI Status 

##### Table D5: Changes in Pell Grants by institution's MSI status

```{r pell.msi}
kable(recipients.msi) %>% kable_paper("hover", full_width = F)
kable(disbursements.msi) %>% kable_paper("hover", full_width = F)
```

#### Maximum Window of Comparison

##### Table D6: Changes in Pell Grants for all institutions

```{r pell.bigwindow}
kable(preprocessRecipients(bigWindowR)) %>% kable_paper("hover", full_width = F)
kable(preprocessDisbursements(bigWindowD)) %>% kable_paper("hover", full_width = F)
```

#### Totals

##### Table D7: Total count of Pell Grant recipients and disbursements

```{r pell.total}
kable(preprocessTotals(totalsPull)) %>% kable_paper("hover", full_width = F)
```
...
setStudentLevels <- c(
  ...
  "First-time undergrads", 
  "Full-time undergrads", 
  "First-time full-time undergrads", 
  "Part-time undergrads", 
  "First-time part-time undergrads", 
  "Undergrads at high-Pell institutions", 
  "Undergrads at medium-Pell institutions", 
  "Undergrads at low-Pell institutions", 
  "Undergrads at public institutions", 
  "Undergrads at nonprofit institutions", 
  "Undergrads at for-profit institutions", 
  "Undergrads at certificate-granting institutions", 
  "Undergrads at associate-granting institutions", 
  "Undergrads at bachelor-granting institutions"
)
```
...
studentTable <- data.frame(
  `Variable` = character(),
  `Student category` = character(),
  `Variable of interest` = character(),
  `Demographic group` = character(), 
  `Selected students` = character(),
  check.names=FALSE
)

studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "All undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "ASIA",
  `Selected students` = "Asian"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "BKAA",
  `Selected students` = "Black or African American"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "HISP",
  `Selected students` = "Hispanic or Latino"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "AIAN",
  `Selected students` = "Native American or Alaska Native"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "NHPI",
  `Selected students` = "Native Hawaiian or Other Pacific Islander"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "WHIT",
  `Selected students` = "White"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "2MOR",
  `Selected students` = "Two or more races"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Full-time undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Full-time undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time full-time undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time full-time undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "Part-time undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "Part-time undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "All",
  `Student category` = "First-time part-time undergrads",
  `Variable of interest` = "None",
  `Demographic group` = "TOTL",
  `Selected students` = "First-time part-time undergrads"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "High Pell",
  `Student category` = "Undergrads",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at high-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Medium Pell",
  `Student category` = "Undergrads",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at medium-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "Low Pell",
  `Student category` = "Undergrads",
  `Variable of interest` = "PCTPELL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at low-Pell institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "Undergrads",
  ...
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at public institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "Undergrads",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at nonprofit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "Undergrads",
  `Variable of interest` = "CONTROL",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at for-profit institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "1",
  `Student category` = "Undergrads",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at certificate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "2",
  `Student category` = "Undergrads",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at associate-granting institutions"
)
studentTable <- studentTable %>% add_row(
  `Variable` = "3",
  `Student category` = "Undergrads",
  `Variable of interest` = "PREDDEG",
  `Demographic group` = "TOTL",
  `Selected students` = "Undergrads at bachelor-granting institutions"
)
...
enroll.ftft <- rbind(
  ...
  enroll.PTUG.AL,
  enroll.PTUG.TX,
  # Part-time, first-time undergraduate students
  enroll.PT1GUG.IL,
  enroll.PT1GUG.AL,
  enroll.PT1GUG.TX
)
...
enroll.pell <- rbind(
  # Enrollment: All undergraduates by Pell share
  enroll.PCTPELL.LA,
  enroll.PCTPELL.IL,
  enroll.PCTPELL.AL,
  enroll.PCTPELL.TX
...
enroll.control <- rbind(
  # Enrollment: All undergraduates by institutional control
  enroll.CONTROL.LA,
  enroll.CONTROL.IL,
  enroll.CONTROL.AL,
  enroll.CONTROL.TX
...
enroll.preddeg <- rbind(
  # Enrollment: All undergraduates by predominant degree awarded
  enroll.PREDDEG.LA,
  enroll.PREDDEG.IL,
  enroll.PREDDEG.AL,
  enroll.PREDDEG.TX
...
preprocessEnroll <- function(data0){
  
  data0 <- left_join(
    x=data0, y=studentTable, by=c("Variable", "Student category", "Variable of interest", "Demographic group")
  ) %>% filter(
    is.na(`Selected students`)==FALSE
  )
  ...
  data0 <- data0 %>% select(
    ...
    `Comparison years`, 
    `Selected students`, 
    `Enrollment change, selected state`, 
    `Enrollment change, rest of U.S.`, 
    `Percentage point difference`
  )
  
  data0$`Selected students` <- as.factor(data0$`Selected students`)
  data0$`Selected students` <- factor(data0$`Selected students`, levels=setStudentLevels)
  
  data0 <- data0 %>% arrange(`State`, `Selected students`)
...
##### Table E1: Changes in undergraduate enrollment by first-time status and enrollment intensity

```{r enroll.ftft}
kable(enroll.ftft) %>% kable_paper("hover", full_width = F)
```

#### Pell share 

##### Table E2: Changes in undergraduate enrollment by institution's Pell share of undergraduate enrollment 

```{r enroll.pell}
kable(enroll.pell) %>% kable_paper("hover", full_width = F)
```

#### Control

##### Table E3: Changes in undergraduate enrollment by institution's control

```{r enroll.control}
kable(enroll.control) %>% kable_paper("hover", full_width = F)
```

#### Predominant degree 

##### Table E4: Changes in undergraduate enrollment by institution's predominant degree awarded

```{r enroll.preddeg}
kable(enroll.preddeg) %>% kable_paper("hover", full_width = F)
```

#### Race/ethnicity 

##### Table E5: Changes in undergraduate enrollment by race/ethnicity

```{r enroll.race}
kable(enroll.race) %>% kable_paper("hover", full_width = F)
```
...
```{r preprocessActiveStudents}
activeStudents <- activeStudents %>% rename(
  `Grade 12 students` = `Grade 12 Students [State] 2023-24`
) %>% mutate(
  `Grade 12 students` = comma(`Grade 12 students`), 
  `Share of total` = percent(`Share of total`, accuracy=0.1)
)
```

```{r activeStudents}
kable(activeStudents) %>% kable_paper("hover", full_width = F)
```
...
comp1 <- comp1 %>% mutate(
  `CalSOAP` = ifelse(
    `CalSOAP` == "CalSOAP participant", "Yes", "No"
  )
) %>% pivot_wider(
  id_cols=c(`CalSOAP`), 
  names_from=`Year`, 
  ...
  `Percentage point change` = `Class of 2023` - `Class of 2022`
) %>% mutate(
  `Percentage point change` = ifelse(
    `Percentage point change` >= 0, 
    paste("+", round(`Percentage point change` * 100, 2), " pp", sep=""), 
    paste("-", round(`Percentage point change` * 100, 2), " pp", sep="")
  )
) %>% mutate(
  `FAFSA completion rate` = percent(`FAFSA completion rate`, accuracy=0.1)
) %>% rename(
  `FAFSA completion rate, class of 2022` = `Class of 2022`, 
  `FAFSA completion rate, class of 2023` = `Class of 2023`, 
  `High School is a Cal-SOAP Consortium Member` = `CalSOAP`
)

```

```{r calSoap}
kable(comp1) %>% kable_paper("hover", full_width = F)
```

#### Mixed-Status Families

##### Table F3: Estimated U.S. Citizens Living with a Noncitizen, Nationwide and in Mandatory FAFSA States

```{r preprocessMixedStatus}

preprocessMixedStatus <- function(data0){
  
  data0 <- data0 %>% filter(
  `Mixed household` == "Mixed"
) %>% select(
  -(`Mixed household`)
) %>% mutate(
  `PWGTP` = comma(`PWGTP`)
)
  data0$`State`[data0$`State`=="Overall"] <- "U.S. overall"
  
  data0 <- data0 %>% arrange(`State`)
  
  return(data0)
}

agg0 <- rbind(
  preprocessMixedStatus(agg0overall), 
  preprocessMixedStatus(agg0states)
) %>% rename(
  `Overall` = `PWGTP`
)

agg1 <- rbind(
  preprocessMixedStatus(agg1overall), 
  preprocessMixedStatus(agg1states)
) %>% rename(
  `Enrolled in Grade 12` = `PWGTP`
)

agg2 <- rbind(
  preprocessMixedStatus(agg2overall), 
  preprocessMixedStatus(agg2states)
) %>% rename(
  `Aged 17 to 23` = `PWGTP`
)

mixedStatus <- full_join(x=agg0, y=full_join(
  x=agg1, y=agg2, by="State"
), by="State")

```

```{r mixedStatus}
kable(mixedStatus) %>% kable_paper("hover", full_width = F)
```
