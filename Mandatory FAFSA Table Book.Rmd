...
This appendix contains the tables used in our full report. Each set of tables contains a "Data Source and Notes" tab containing methodological details. For the full methods used, see the methods document [here](https://docs.google.com/document/d/1SkZ9OzfMQQcvnTz2AEVRnx4WPu8ybv-yCd_n3ZpiIM4/edit?usp=sharing). 
...
kable(xLA1) %>% kable_paper("hover", full_width = F)
```
...
kable(xLA2) %>% kable_paper("hover", full_width = F)
```
...
kable(xLA3) %>% kable_paper("hover", full_width = F)
```
...
kable(xIL1) %>% kable_paper("hover", full_width = F)
```
...
kable(xIL2) %>% kable_paper("hover", full_width = F)
```
...
kable(xIL3) %>% kable_paper("hover", full_width = F)
```
...
kable(xAL1) %>% kable_paper("hover", full_width = F)
```
...
kable(xAL2) %>% kable_paper("hover", full_width = F)
```
...
kable(xAL3) %>% kable_paper("hover", full_width = F)
```
...
kable(xTX1) %>% kable_paper("hover", full_width = F)
```
...
kable(xTX2) %>% kable_paper("hover", full_width = F)
```
...
kable(xTX3) %>% kable_paper("hover", full_width = F)
```
...
kable(xCA1) %>% kable_paper("hover", full_width = F)
```
...
kable(xCA2) %>% kable_paper("hover", full_width = F)
```
...
kable(xCA3) %>% kable_paper("hover", full_width = F)
```
...
kable(xIN1) %>% kable_paper("hover", full_width = F)
```
...
kable(xIN2) %>% kable_paper("hover", full_width = F)
```
...
kable(xIN3) %>% kable_paper("hover", full_width = F)
```
...
kable(xNH1) %>% kable_paper("hover", full_width = F)
```
...
kable(xNH2) %>% kable_paper("hover", full_width = F)
```
...
kable(xNH3) %>% kable_paper("hover", full_width = F)
```
...
Tables D1 through D6 inform Table 4 in the report. 
...
preprocessEnrollTotals <- function(data0){
...
Table F1 informs the introduction to the report, Table F2 informs Table 6 in the report, and Table F3 informs Table 7 in the report. 
...
```{r pLA1}
ggplotly(pLA1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yLA1) %>% kable_paper("hover", full_width = F)
```

##### Figure G1b: FAFSA completion rates by Black or Latino share of enrollment: Louisiana

```{r pLA2}
ggplotly(pLA2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yLA2) %>% kable_paper("hover", full_width = F)
```
...
```{r pIL1}
ggplotly(pIL1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yIL1) %>% kable_paper("hover", full_width = F)
```

##### Figure G2b: FAFSA completion rates by Black or Latino share of enrollment: Illinois

```{r pIL2}
ggplotly(pIL2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yIL2) %>% kable_paper("hover", full_width = F)
```
...
```{r pAL1}
ggplotly(pAL1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yAL1) %>% kable_paper("hover", full_width = F)
```

##### Figure G3b: FAFSA completion rates by Black or Latino share of enrollment: Alabama

```{r pAL2}
ggplotly(pAL2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yAL2) %>% kable_paper("hover", full_width = F)
```
...
```{r pTX1}
ggplotly(pTX1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yTX1) %>% kable_paper("hover", full_width = F)
```

##### Figure G4b: FAFSA completion rates by Black or Latino share of enrollment: Texas

```{r pTX2}
ggplotly(pTX2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yTX2) %>% kable_paper("hover", full_width = F)
```
...
```{r pCA1}
ggplotly(pCA1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yCA1) %>% kable_paper("hover", full_width = F)
```

##### Figure G5b: FAFSA completion rates by Black or Latino share of enrollment: California

```{r pCA2}
ggplotly(pCA2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yCA2) %>% kable_paper("hover", full_width = F)
```
...
```{r pIN1}
ggplotly(pIN1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yIN1) %>% kable_paper("hover", full_width = F)
```

##### Figure G6b: FAFSA completion rates by Black or Latino share of enrollment: Indiana

```{r pIN2}
ggplotly(pIN2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yIN2) %>% kable_paper("hover", full_width = F)
```
...
```{r pNH1}
ggplotly(pNH1, width=q1width, height=q1height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yNH1) %>% kable_paper("hover", full_width = F)
```

##### Figure G7b: FAFSA completion rates by Black or Latino share of enrollment: New Hampshire

```{r pNH2}
ggplotly(pNH2, width=q2width, height=q2height, tooltip="text") %>% layout(legend = list(orientation = "h"))

kable(yNH2) %>% kable_paper("hover", full_width = F)
```
...
These numbers are used for comparison with Figures B1 through B7. 
