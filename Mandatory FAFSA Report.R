...
merge24 <- left_join(
  x=merge24, 
  y=processEnrollment1(read.csv("ccd_sch_052_2324.csv", header=TRUE)), 
  by="NCESSCH-ELSI"
...
qLA1 <- quintilePlot(quintiles.louisiana, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2017", "Class of 2018")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qIL1 <- quintilePlot(quintiles.illinois, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2020", "Class of 2021")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qAL1 <- quintilePlot(quintiles.alabama, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qTX1 <- quintilePlot(quintiles.texas, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qCA1 <- quintilePlot(quintiles.california, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2022", "Class of 2023")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qIN1 <- quintilePlot(quintiles.indiana, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qNH1 <- quintilePlot(quintiles.newhampshire, "Groups: Share of population in poverty", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

#### End #### 

#### Figures 8-14 carousel: Degree attainment ####

qLA2 <- quintilePlot(quintiles.louisiana, "Groups: No college share", TRUE, TRUE, c("Class of 2017", "Class of 2018")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qIL2 <- quintilePlot(quintiles.illinois, "Groups: No college share", TRUE, TRUE, c("Class of 2020", "Class of 2021")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qAL2 <- quintilePlot(quintiles.alabama, "Groups: No college share", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qTX2 <- quintilePlot(quintiles.texas, "Groups: No college share", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qCA2 <- quintilePlot(quintiles.california, "Groups: No college share", TRUE, TRUE, c("Class of 2022", "Class of 2023")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qIN2 <- quintilePlot(quintiles.indiana, "Groups: No college share", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

qNH2 <- quintilePlot(quintiles.newhampshire, "Groups: No college share", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3) + labs(fill="Quintile: Share of adults without degrees")

#### End ####

#### Figures 15-21 carousel: Race and ethincity ####

qLA3 <- quintilePlot(quintiles.louisiana, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2017", "Class of 2018")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qIL3 <- quintilePlot(quintiles.illinois, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2020", "Class of 2021")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qAL3 <- quintilePlot(quintiles.alabama, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qTX3 <- quintilePlot(quintiles.texas, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2021", "Class of 2022")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qCA3 <- quintilePlot(quintiles.california, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2022", "Class of 2023")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qIN3 <- quintilePlot(quintiles.indiana, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)

qNH3 <- quintilePlot(quintiles.newhampshire, "Groups: Black or Latino share", TRUE, TRUE, c("Class of 2023", "Class of 2024")) # + geom_text(aes(label=percent(`FAFSA completion rate`, accuracy=0.1)), position=position_dodge(width=0.9), vjust=-0.55, size=3)
